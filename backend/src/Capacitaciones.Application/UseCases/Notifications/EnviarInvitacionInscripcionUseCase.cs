...
public class EnviarInvitacionInscripcionUseCase
{
    ...
    public async Task<InvitacionInscripcionResultDto> ExecuteAsync(Guid capacitacionId, string adminEmail, CancellationToken ct = default)
    {
        ...
        var subject = $"Invitación a {tipoActividad}: {entity.Tema}";
